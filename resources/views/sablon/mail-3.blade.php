            ...
            <tr>
                <td>
                    ...
                    <table width="600" class="content" bgcolor="#fff" align="center" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td width="150">
                                <img src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/img/tehnologia-succesului.jpg" width="150px" height="120px">
                            </td>
                            <td width="10">&nbsp;</td>
                            <td width="300">
                                <img src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/img/tehnologia-succesului-center.jpg" width="275px" height="120px">
                            </td>
                    ...
                    <table class="content" width="600" height="25" bgcolor="#333333" align="center" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td width="10"></td>
                        <td style="color: #fff">
                    ...
                    <table class="content" width="600" height="200" bgcolor="#fff" align="center" bordercolor="#333333" border="2" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td style="">
